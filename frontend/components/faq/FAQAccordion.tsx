        ...
        items: [
            {
                ...
                answer: "Annu Design Studio is a next-generation creative agency that blends human expertise with advanced AI tools to deliver stunning designs for branding, web, and marketing."
            },
            {
